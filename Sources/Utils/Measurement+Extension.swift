...
internal func prepareSpeedTestSummary(
  data: [MeasurementProgress], tcpInfos: [TCPInfo], for: TestDirection, unit: MeasurementUnit
) -> SpeedTestSummary {
...
internal func computeLatencyAndRetransmission(_ tcpInfos: [TCPInfo], for direction: TestDirection)
